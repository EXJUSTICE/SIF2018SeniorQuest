...
public class MapActivity extends AppCompatActivity implements
    ...
    @Override
        ...
        public ArrayList<Quest> createFakeHolder(){
          ArrayList<Quest> questHolder = new ArrayList<Quest>();
            Quest q1 = new Quest("SG-001","TEST 1","This is a test quest","SG",1.297102,103.787473,"Play chess/Talk to auntie/Practice mandarin/test","test1","test2","test3",false,0,"lol");
            Quest q2 = new Quest("SG-002","TEST 2","This is a test quest","SG",1.296164,103.788011,"Speak to grandson/Buya yeo's lemon tea/Take your pills/test","test1","test2","test3",false,0, "lol");
            Quest q3 = new Quest("SG-003","TEST 3","This is a test quest","SG",1.298732,103.788138,"Play Shogi/Talk to grandpa/Train your memory/test","test1","test2","test3",false,1, "lol");
            Quest q4 = new Quest("SG-004","TEST 4","This is a test quest","SG",1.298840,103.788782,"Read ST times/Look at a plant/Call your friend/test","lightbulb-bulb-light","Is there a lightbulb?-yes-yes","test3",false,0, "lol");
    ...
    */
    ...
    //Need to add a few more quests near us
    public void InsertQuestDataIntoDB () {
        addQuest("LDNC-001","TEST 1","This is a test quest","LDNC",1.297102,103.787473,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",1);
        addQuest("LDNC-002","TEST 2","This is a test quest","LDNC",1.296164,103.788011,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",1);
        addQuest("LDNC-003","TEST 3","This is a test quest","LDNC",1.298732,103.788138,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",2);
        addQuest("LDNC-004","TEST 4","This is a test quest","LDNC",1.298840,103.78878,"Objective1/Objective2/Objective3/Objective4","lightbulb-bulb-light","Is there a lightbulb?-yes-yes","test3","false",2);

        addQuest("SG-001","TEST 1","This is a test quest","SG",1.297102,103.787473,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",1);
        addQuest("SG-002","TEST 2","This is a test quest","SG",1.296164,103.788011,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",1);
        addQuest("SG-003","TEST 3","This is a test quest","SG",1.298732,103.788138,"Objective1/Objective2/Objective3/Objective4","test1","test2","test3","false",2);
        ...
        switch (requestCode) {
            ...
            case QR_REQUEST:
                    if (resultCode == RESULT_OK) {
                        ...
                        Toast.makeText(MapActivity.this, qrData, Toast.LENGTH_LONG).show();
